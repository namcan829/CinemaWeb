<%-- 
    Document   : navbar_headerdash
    Created on : Mar 22, 2025, 11:19:37 AM
    Author     : NgoQuan
--%>
...
<html>
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="">Trang quản lý hệ thống</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="homepage"><i class="fa-solid fa-file"></i> Homepage</a></li>
                        <li><hr class="dropdown-divider" /></li>
                        <li><a class="dropdown-item" href="logout">
                                <i style="color: #ff6600" class="fa-solid fa-right-from-bracket"></i> Đăng xuất</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
